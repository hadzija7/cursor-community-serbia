...
- [x] Hackathon date/location synced from Luma event page (`/api/hackathon/event`, static fallback)
  ...
  - [x] Hackathon prizes: Convex aside links the online All Gas hackathon (`luma.com/convex-allgas-hackathon`)
  ...
  - [x] Hackathon final top 3: confirm/override is admin-only; no provisional top-3 cards or cash on pickers/cards; published cards show place only
  ...
  - [x] Hackathon submit: admin (`HACKATHON_ADMIN_EMAILS`) can close/reopen the form; POST blocked while closed
