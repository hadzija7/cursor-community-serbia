...
- Judges: Ben Kim — founder, investor & community builder; Codex and SpaceX ambassador; photo `public/images/hackathon/ben-kim.jpg` (`photoPosition: center`); X `benkimbuilds`, LinkedIn `benkimbuilds`. Milan Lazarević — software engineer & ML specialist (CV, edge AI, LLMs, agents, RAG; optimized inference / real-time apps); photo `public/images/hackathon/milan-lazarevic.jpg` (`photoPosition: center`); X `MrLaki5`, LinkedIn `mrlaki5`. Agrim Singh — AI adoption at SpaceXAI and regional community lead for SEA/Singapore; teaches at Code with AI, runs 65 Labs; whisky guru and DJ; photo `public/images/hackathon/agrim-singh.jpg` (`photoPosition: center`); X `agrimsingh`, LinkedIn `agrims`
