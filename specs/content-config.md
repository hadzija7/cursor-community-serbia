...
| `content/hackathon.ts` | Hackathon event copy, Luma URL, prize tracks, hacker guide, mentors/judges, sponsor logos, community partners, stack profiles (including `mcp` install config) |
