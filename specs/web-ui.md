...
- [ ] `/hackathon/mentors` shows Hosts (Aleksandar, Goran, Vladimir Hristov), mentors (Nick Tomić, Miodrag Vilotijević, Miodrag Todorović), and published judges (Ben Kim, Milan Lazarević, Agrim Singh, Marija Mladenović)
