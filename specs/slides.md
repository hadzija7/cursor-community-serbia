...
- **Routes:** `app/slides/[id]/page.tsx` (example deck), `app/education/productivity-with-ai/[id]/page.tsx`, `app/education/coworking-day/[id]/page.tsx`
- **Layouts:** `app/slides/layout.tsx`, `app/education/productivity-with-ai/layout.tsx`, and `app/education/coworking-day/layout.tsx` wrap slide pages with `SlideLayout` so the shell **stays mounted** when `[id]` changes — **browser fullscreen persists** across slide navigation (client-side route changes only swap page content).
