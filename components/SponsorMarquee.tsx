  ...
  return (
    <section className="space-y-5" aria-labelledby="sponsor-marquee-heading">
      <div className="space-y-2 text-center">
        ...
        <h2 id="sponsor-marquee-heading" className="text-2xl font-semibold tracking-tight md:text-3xl">
          {t('hackathon.sponsorsTitle')}
        </h2>
      </div>

      <div className="relative w-full overflow-hidden rounded-2xl border border-cursor-accent-orange/25 bg-cursor-bg-dark py-5">
