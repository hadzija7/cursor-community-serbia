  ...
  const content = (
    <>
      <div className="flex items-baseline justify-between gap-4 mb-6">
        <div>
          <h2 className={embedded ? 'text-lg font-semibold text-cursor-text' : 'text-xl font-semibold text-cursor-text'}>
            {t('recap.galleryTitle')}
          </h2>
          <p className="text-cursor-text-muted text-sm mt-1">{t('recap.gallerySubtitle', { count: String(photos.length) })}</p>
        </div>
      </div>
